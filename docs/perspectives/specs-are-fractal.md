...
That's the article in three sentences. The rest unpacks why it matters and what to do about it. (For the conceptual reference written as part of the [First Principles](/first-principles/) section, see [The Fractal Nature of Design](/first-principles/fractal-design). This piece is the essay-style argument with the AI angle front and centre.)
