---
title: Where "Spec-Driven Development" Came From
prev:
...
![Where Spec-Driven Came From](/images/pages/origins.png)
...
The practitioner thread, traceable through TDD (~2000), BDD (2003-2006), DDD (2003), EventStorming (2013), Event Modeling (2018), Narrative-Driven Development (2018) and into the 2025 commercial wave, established that specifications can be readable by cross-functional teams, that they can describe systems at multiple zoom levels, and that they can guide AI-assisted development.
