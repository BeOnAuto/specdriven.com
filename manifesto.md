...
Every prompt is a specification in disguise. When you type "build me an e-commerce checkout" into an AI tool, you've just written a specification. A vague, implicit, disposable one. The specification decisions still got made (what payment methods to support, how to handle inventory, what the error states look like). They just got made by the AI instead of by you, silently, without review, and without any record of what was decided.

AI hasn't changed the fundamental problem. It's removed the buffer that used to hide it.

## The Quality Crisis

[85% of all software defects originate at the specification stage](/why#where-your-bugs-really-come-from), before a single line of code is written. Not at the coding stage. Not at the testing stage. At the stage where someone decides what to build, and communicates that decision to others.
